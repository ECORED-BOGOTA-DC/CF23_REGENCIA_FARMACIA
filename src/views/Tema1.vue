...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .container-img-text.col-xl-10.mx-auto.mb-5
      img.mb-4.mb-md-auto.mx-auto(src="@/assets/curso/temas/tema1/img-1.svg" style="max-width: 388px" alt="imagen decorativa" data-aos="fade-right")
      .tarjeta.tarjeta-img-text(data-aos="fade-left")
    ...
    .container-100.d-flex.flex-wrap.mb-5(
      ...
      .col-lg-4.col-8.order-lg-2.order-1.mb-lg-0.mb-4.mx-auto(data-aos="fade-left")
        img.mb-4.mb-md-auto.mx-auto.me-lg-0(src="@/assets/curso/temas/tema1/img-2.png" style="max-width: 284px" alt="imagen decorativa")

    p.mb-5(data-aos="fade-right") La normatividad legal vigente para establecimientos y servicios farmacéuticos requiere que el SGC tenga un enfoque basado en procesos. <b>La Norma ISO 9001 del 2008</b> define dicho enfoque como:
            ...
            .col-md-6.col-xl.mb-4.mb-xl-0.d-flex
              .tarjeta-numerada.color-acento-contenido.p-5
                .tarjeta-numerada__numero
                  .h2 1
                p.mb-0 Ofrecer productos y servicios de calidad, que satisfagan las necesidades de los clientes, siempre bajo el margen de la normatividad y legalidad aplicables.

            .col-md-6.col-xl.mb-4.mb-xl-0.d-flex
              .tarjeta-numerada.color-acento-contenido.p-5
                .tarjeta-numerada__numero
                  .h2 2
                p Favorecer las oportunidades de incrementar los indicadores de satisfacción de los clientes.
          .d-flex.flex-wrap.mb-4.mb-lg-auto
            .col-md-6.col-xl.mb-4.mb-xl-0.d-flex
              .tarjeta-numerada.color-acento-contenido.p-5
                .tarjeta-numerada__numero
                  .h2 3
                p.mb-0 Adquirir la capacidad de enfrentar todos los riesgos y las oportunidades que estén ligadas con el contexto empresarial y los objetivos de la misma.

            .col-md-6.col-xl.mb-4.mb-xl-0.d-flex
              .tarjeta-numerada.color-acento-contenido.p-5
                .tarjeta-numerada__numero
                  .h2 4
                p Tener la capacidad de demostrar que la empresa está conformada de acuerdo con los requisitos especificados por el SGC.

    h3.mb-4(data-aos="fade-left") Enfoque del Sistema de Gestión de la Calidad basado en la norma internacional

    p(data-aos="fade-right") Como ya se mencionó anteriormente, la Norma ISO-9001 tiene un enfoque a procesos, el cual permite que la empresa pueda planificar cada uno de los procesos que lleva a cabo y sus intersecciones.

    p.mb-5.mb-md-0(data-aos="fade-right") Este enfoque de procesos incluye el ciclo PHVA (Planificar, Hacer, Verificar y Actuar), el cual permite a la empresa cerciorarse y garantizar que cada uno de sus procesos cuenta con los recursos necesarios y que se están llevando a cabo adecuadamente, además, determinar las oportunidades de mejora y actuar en consecuencia.

    .container-100.d-flex.flex-wrap.mb-5.py-5(
      :style="{'background-image': `url(${require('@/assets/curso/temas/tema1/bg-3.svg')})`}"
      style="background-repeat: no-repeat; background-position: center;"
    )
      ImagenInfografica.color-secundario.mx-auto.infografia-edit(data-aos="zoom-in")
        ...
        .tarjeta.p-3(x="29%" y="29.5%" numero="" style="background-color: #E4DEF4")
          b Actuar
          p Se toman acciones de mejora de desempeño.
        .tarjeta.p-3(x="72%" y="29.5%" numero="" style="background-color: #E4DEF4")
          b Hacer
          p Poner en práctica lo planificado.
        .tarjeta.p-3(x="29%" y="68%" numero="" style="background-color: #E4DEF4")
          b Planificar
          p En este punto, se establecen los objetivos y los recursos, además, se identifican y abordan los riesgos y las oportunidades.
        .tarjeta.p-3(x="72%" y="68%" numero="" style="background-color: #E4DEF4")
          b Verificar
          p Se realiza seguimiento y medición de los procesos, productos, servicios, objetivos, requisitos y actividades planificadas, y se elabora un informe de resultados.

    h3.mb-4(data-aos="fade-left") Principios de gestión de la calidad

    p(data-aos="fade-right") Los principios de gestión de la calidad son aquellos definidos en la Norma ISO-9000 y que toda empresa debe seguir para lograr obtener los mejores resultados. Un Sistema de Gestión de la Calidad puede estar muy bien implementado desde los requisitos de la ISO-9001, pero, si no sigue los principios, sus objetivos de seguro no podrán ser alcanzados.

    p.mb-5(data-aos="fade-right") Los siete principios de la gestión de la calidad descritos en la Norma ISO-9000 son:

    TabsC.color-secundario(data-aos="zoom-in")
      .py-3.py-md-4(titulo="Enfoque")
        .row.justify-content-center.px-2
          ...
          .col-lg-7.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/temas/tema1/tbc-1.svg' style="max-width: 610px" alt="imagen decorativa")
      .py-3.py-md-4(titulo="Liderazgo")
        .row.justify-content-center.px-2
          ...
          .col-lg-7.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/temas/tema1/tbc-2.svg' style="max-width: 610px" alt="imagen decorativa")
      .py-3.py-md-4(titulo="Compromiso")
        .row.justify-content-center.px-2
          ...
          .col-lg-7.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/temas/tema1/tbc-3.svg' style="max-width: 610px" alt="imagen decorativa")
      .py-3.py-md-4(titulo="Mejora")
        .row.justify-content-center.px-2
          ...
          .col-lg-7.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/temas/tema1/tbc-4.svg' style="max-width: 610px" alt="imagen decorativa")
      .py-3.py-md-4(titulo="Decisiones")
        .row.justify-content-center.px-2
          ...
          .col-lg-7.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/temas/tema1/tbc-5.svg' style="max-width: 610px" alt="imagen decorativa")
      .py-3.py-md-4(titulo="Gestión")
        .row.justify-content-center.px-2
          ...
          .col-lg-7.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/temas/tema1/tbc-6.svg' style="max-width: 610px" alt="imagen decorativa")
